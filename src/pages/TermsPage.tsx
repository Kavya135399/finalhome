...
const sections = [
  { heading: '1. Acceptance of Terms', body: ['By accessing or using Bhale Padharya, you agree to be bound by these Terms. If you do not agree, please do not use our services.'] },
  ...
  { heading: '8. Liability', body: ['Bhale Padharya acts as a platform connecting customers with professionals. We are not liable for damages beyond the service fee paid, except where prohibited by law.'] },
...
export function TermsPage() {
  return (
    <LegalPage
      ...
      intro="These terms govern your use of Bhale Padharya. Please read them carefully before using our platform."
      sections={sections}
    />
  );
}
